...
class Point(object):
    ...
    def clone(self):
        """"Creates and returns a new Point at the same x and y as self"""
    ...
    def halfway_to(self, p1):
        p = Point((self.x + p1.x) / 2, (self.y + p1.y) / 2)
        return p
...
def run_test_get_number_of_moves_made():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 8.  Follow the same instructions as in DONE3 above,
...
def run_test_get_distance_from():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 9.  Follow the same instructions as in TO 3 above,
...
def run_test_get_distance_from_start():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 10.  Follow the same instructions as in TO 3 above,
...
def run_test_get_distance_traveled():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 11.  Follow the same instructions as in TO 3 above,
...
def run_test_closer_to():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 12.  Follow the same instructions as in TO 3 above,
